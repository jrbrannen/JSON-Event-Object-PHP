<?php
    ...
    try{
        $sql = "SELECT events_id, events_name, events_description, events_presenter, TIME_FORMAT(events_time, '%h: %i %p') as events_time, DATE_FORMAT(events_date, '%M %d, %Y') as events_date FROM wdv341_events WHERE events_id = 1";   //sql command as a string variable formats time and date in sql
...
<html lang="en">
    ...
    <body class="col-10 mx-auto">
        ...
        <footer>
            ...
            <p class="text-center">
                <a target="_blank"href="">GitHub Repo Link</a> <!--  GitHub Repo Link -->
            </p>
